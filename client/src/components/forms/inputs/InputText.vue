...
withDefaults(defineProps<{ modelValue: string | number; type?: 'text' | 'email' | 'number' | 'password', label?: string, required?: boolean, idKey?: string, readonly?: boolean; inputClass?: string, labelClass?: string, placeholder?: string }>(), {
    type: 'text',
